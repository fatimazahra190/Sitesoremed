            ...
            <div class="auth-form">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input @error('consent') is-invalid @enderror" type="checkbox" name="consent" id="consent" value="1" {{ old('consent') ? 'checked' : '' }} required>
                        <label class="form-check-label" for="consent">
                            J'accepte le traitement de mes données personnelles (RGPD)
                        </label>
                        @error('consent')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                    <div class="d-grid">
